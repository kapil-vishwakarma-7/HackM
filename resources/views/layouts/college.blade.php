        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    <li class="xn-logo">
                        <a href="{{ route('dash.college.') }}">HackM</a>
                    ...
                    <li class="xn-profile">
                        ...
                        <div class="profile">
                            ...
                            <div class="profile-data">
                                <div class="profile-data-name">College</div>
                    ...
                    <li class="active">
                        <a href="{{ route('dash.college.') }}"><span class="fa fa-desktop"></span> <span class="xn-text">Dashboard</span></a>                        
                    </li>                    
                    ...
                    <li class="xn-openable">
                        ...
                        <ul>
                           <li><a href="#"><span class="fa fa-arrow-right"></span> View company</a></li>
                            <li><a href="#"><span class="fa fa-arrow-right"></span> Placement</a></li>
                              <li><a href="#"><span class="fa fa-arrow-right"></span> Send message</a></li>
                        </ul>
                    </li>
                   <li class="xn-openable">
                        <a href="#"><span class="fa fa-user"></span> <span class="xn-text">Placement</span></a>
                        <ul>
                           <li><a href="#"><span class="fa fa-arrow-right"></span> View Placed Student</a></li>
                            <li><a href="#"><span class="fa fa-arrow-right"></span> Not Placed</a></li>
                    ...
                    <li class="xn-openable">
                        <a href="#"><span class="fa fa-edit"></span> <span class="xn-text">Courses</span></a>
                        <ul>
                         <li><a href="#"><span class="fa fa-arrow-right"></span> Add courses</a></li>   
                         <li><a href="#"><span class="fa fa-arrow-right"></span> View courses</a></li>
